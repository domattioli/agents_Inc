...
4-rung ladder, each rung a claude↔codex pair. Rung↔pair mapping is `docs/governance/ROUTING-RANKING.md` "Rungs" table of record — not restated here.

| Rung | Does | Children? |
|---|---|---|
| Supervisor | final say, risk eval, conflicting results, irreversible acts | yes |
| Orchestrator | decompose, dispatch, complex planning/multi-step delegation | yes |
...
14. lesson-learned handling — tag `LESSON-CANDIDATE`, relay exactly one rung up, scout-checked vs canon before it reaches Supervisor
