...
## 1. Why pool model capacity&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 2. Asking for work in plain language&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 3. How the speckit pipeline and grilling are adapted here&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 4. How the governed pool works&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 5. Project status&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 6. Where it fits&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 7. Limitations&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 8. Future work&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 9. Getting started&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
...
## 10. Appendix: HTTP bridge&emsp;&emsp;&emsp;&emsp;<sub>[^ Back to top](#agents_inc)</sub>
